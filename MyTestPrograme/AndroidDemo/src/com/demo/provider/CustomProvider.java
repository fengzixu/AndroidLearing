...
public class CustomProvider extends ContentProvider {
	...
	public String getType(Uri uri) {
		...
		case BOOK_DIR: return "vnd.android.cursor.dir/vnd.com.example.androiddemo.provider.book";
		case BOOK_ITEM:return"vnd.android.cursor.item/vnd.com.example.androiddemo.provider.book";
		case CATEGORY_DIR: return "vnd.android.cursor.dir/vnd.com.example.androiddemo.provider.category";
		case CATEGORY_ITEM:return"vnd.android.cursor.item/vnd.com.example.androiddemo.provider.category";			
		}
		return null;
	}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case BOOK_ITEM:
			...
			String bookid = uri.getPathSegments().get(1);
			Log.i("xuran", "delete id is " + bookid);
